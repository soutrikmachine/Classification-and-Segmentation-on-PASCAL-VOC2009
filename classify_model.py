#Creating the classifier -- Soutrik
...
image_classifier = classifier(model_path='../model/convolutional_autoencoder.h5',is_fine_tuned=True)
image_classifier.summary()
image_classifier.save("classify_model.h5")
print("The classifier has been saved successfully") 
